  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LocalBusinessSchema
        ...
        abn="47 683 089 652"
        description="Professional mould removal and inspection services in Malvern East Melbourne. IICRC certified technicians specialising in prestigious residential properties, heritage homes, and established family estates."
      />
      ...
      <ServiceSchema
        ...
        description="Professional mould removal and inspection services for Malvern East properties including prestigious residential homes, heritage properties, and established family estates."
      />
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal Malvern East Melbourne specialists with 5+ years experience. IICRC-certified technicians serving Malvern East's prestigious residential properties, heritage homes, and established family estates with same-day response. Trusted by 100+ Melbourne properties with 5.0-star rating.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                Malvern East's combination of prestigious residential properties, heritage architecture, and established family living creates specific mould challenges. Our professional mould removal Malvern East Melbourne team addresses these with premium residential solutions:
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-semibold mb-3 text-primary">Prestigious Property Challenges</h4>
                  <ul className="space-y-2 text-sm">
                    <li>• Heritage residential properties requiring specialised restoration approaches</li>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Our professional mould removal Malvern East Melbourne technicians are IICRC certified with training in prestigious property standards and heritage building requirements, ensuring comprehensive service quality for premium residential communities.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-success mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-professional">Professional Service - Same-day Available 7am-7pm to Malvern East</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-2">100%</div>
                  <div className="text-sm text-professional">Premium-Safe Treatment Methods</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-2">5.0★</div>
                  <div className="text-sm text-professional">Rating from Prestigious Residents</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your Malvern East prestigious home, heritage property, or family estate. Our IICRC-certified technicians provide Professional service line response with 2-hour arrival guarantee. Trusted by premium residential communities and heritage property owners with a 5.0-star rating.
            </p>
