      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in Hawthorn</span>
          ...
          <div className="max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>Same-day emergency response to Hawthorn</span>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="emergency-cta">
                ...
                Call Now for Hawthorn Mould Emergency: 1800 954 117
              </Button>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Emergency Hawthorn Response</h3>
                <p className="text-muted-foreground mb-4">2-hour emergency callout to Hawthorn properties</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <Clock className="w-12 h-12 text-emergency-orange mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-3">2-Hour Emergency Response</h3>
                <p className="text-muted-foreground">
                  Fast response to Hawthorn mould emergencies. Available 7am-7pm every day with same-day service for urgent situations. Professional assessment and immediate action when you need it most.
                </p>
              </div>
              <div className="text-center">
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto text-primary-foreground/90">
            Don't let mould damage your beautiful Hawthorn property or risk your family's health. Our IICRC-certified specialists provide same-day emergency response with expert treatment for period homes and modern properties throughout postcode 3122 and 3123.
          </p>
