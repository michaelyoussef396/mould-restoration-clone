  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceSchema
        ...
        description="Professional mould removal and inspection services for Carnegie properties including village community homes, period properties, and Koornang Road commercial buildings."
      />
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal Carnegie Melbourne specialists with 5+ years experience. IICRC-certified technicians serving Carnegie's village community properties, Koornang Road precinct, and period home renovations with same-day response. Trusted by 100+ Melbourne properties with 5.0-star rating.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Carnegie's combination of period architecture, village community atmosphere, and heritage building preservation creates specific mould challenges. Our professional mould removal Carnegie Melbourne team addresses these with heritage-sensitive solutions:
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Our professional mould removal Carnegie Melbourne technicians are IICRC certified with training in heritage building standards and period property requirements, ensuring comprehensive service quality for village community preservation.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-success mt-0.5 flex-shrink-0" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your Carnegie period property, heritage building, or village community home. Our IICRC-certified technicians provide Professional service line response with 2-hour arrival guarantee. Trusted by heritage property owners and village community residents with a 5.0-star rating.
            </p>
