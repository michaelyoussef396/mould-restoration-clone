          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-charcoal mb-6">
                ...
                <span className="block text-primary">Blackburn Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal">Period Home Architecture Preservation</h4>
                      <p className="text-professional">
                        Blackburn's collection of period homes from the early-mid 20th century requires specialised mould treatment approaches that preserve original architectural features while addressing modern moisture management needs. Our expertise protects heritage value while ensuring healthy living environments.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Established Family Community Needs</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Train Line Environmental Factors</h4>
                      <p className="text-professional">
                        Properties near Blackburn Railway Station and the Belgrave/Lilydale line face unique environmental challenges from transport infrastructure. Train vibrations, modified drainage patterns, and air circulation changes require specialised knowledge for effective mould prevention and treatment.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Mature Garden District Character</h4>
                      <p className="text-professional">
                ...
                <Card className="border-blue-200 bg-columbia">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-charcoal">Blackburn Area Coverage</h3>
                        <p className="text-professional">VIC 3130 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Heritage Period Homes</h3>
                  <p className="text-professional mb-4">
                    Blackburn's charming period homes from the 1920s-1950s feature original architectural details that require careful preservation during mould treatment. These properties often have original timber framing, period plasterwork, and heritage fixtures that need specialised restoration approaches.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Established Family Renovations</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Train Line Corridor Properties</h3>
                  <p className="text-professional mb-4">
                    Homes near Blackburn Railway Station and the Belgrave/Lilydale train lines face unique environmental challenges from transport infrastructure. Railway proximity affects drainage, vibration impacts, and air circulation patterns requiring specialised mould removal Blackburn Melbourne expertise.
                  </p>
                  <ul className="text-sm text-professional space-y-2">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <ul className="text-sm text-professional space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span>Garden-building interface optimisation</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Long-Term Family Residences</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Sanctuary and Parkland Adjacent Homes</h3>
                  <p className="text-professional mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">5+ Years Heritage Property Experience</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Established Family Understanding</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Heritage-Safe Treatment Methods</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Respectful Family Scheduling</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Local Transport Corridor Knowledge</h3>
                  <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Protect Original Building Materials</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Heritage-Appropriate Ventilation Upgrades</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Multi-Generation Renovation Integration</h4>
                      <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Train Line Proximity Considerations</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Sanctuary Area Humidity Monitoring</h4>
                      <p className="text-professional">
