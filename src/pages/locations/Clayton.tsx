  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceSchema
        ...
        description="Professional mould removal and inspection services for Clayton properties including university buildings, student accommodation, research facilities, and surrounding residential developments."
      />
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal Clayton Melbourne specialists with 5+ years experience. IICRC-certified technicians serving Clayton's university precinct properties, student accommodation, and research facilities with same-day response. Trusted by 100+ Melbourne properties with 5.0-star rating.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Clayton's combination of university facilities, high-density student living, and research environments creates specific mould challenges. Our professional mould removal Clayton Melbourne team addresses these with education-sector expertise:
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Our professional mould removal Clayton Melbourne technicians are IICRC certified with training in educational facility standards and research environment requirements, ensuring comprehensive service quality for academic communities.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-success-green mt-0.5 flex-shrink-0" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your Clayton university building, student accommodation, or research facility. Our IICRC-certified technicians provide Professional service line response with 2-hour arrival guarantee. Trusted by educational facilities, student communities, and research institutions with a 5.0-star rating.
            </p>
