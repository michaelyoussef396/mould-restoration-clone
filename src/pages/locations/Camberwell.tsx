      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in Camberwell</span>
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="emergency-cta">
                ...
                Call Now for Camberwell Mould Emergency: 1800 954 117
              </Button>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Emergency Camberwell Response</h3>
