            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>Same-day emergency response to Hughesdale</span>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• 2-hour response time to Hughesdale</li>
                    <li>• Convenient location moisture emergency</li>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
                    <span>5+ years specializing in Hughesdale railway corridor mould issues</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Our IICRC-certified technicians provide emergency response Same-day professional service to Hughesdale railway corridor properties, operating 7am-7pm daily with Professional service hotline (7am-7pm) availability for transport connectivity emergencies. ABN: 47 683 089 652.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  We work directly with all major Australian insurance providers and offer comprehensive documentation for claims related to transport corridor damage, convenient location restoration, and railway area water damage incidents requiring specialized treatment.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-success-green rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <p className="text-lg text-muted-foreground mb-6">
                We provide railway corridor-specialized mould removal services throughout Hughesdale and nearby transport-accessible areas including:
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>Transport connectivity moisture emergency response available</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white">
                <Phone className="w-5 h-5 mr-2" />
                Hughesdale Transport Emergency: 1800 954 117
              </Button>
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving Hughesdale and all railway corridor suburbs • Transport connectivity specialists • Convenient location emergency response available
            </p>
          </div>
        </div>
      </section>
