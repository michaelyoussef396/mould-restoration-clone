        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal in South Yarra Melbourne with same-day response. IICRC-certified technicians specialising in apartments, townhouses, and high-density living environments. 5.0 stars, 100+ properties restored.
            </p>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  All our technicians are IICRC certified with specialised training in apartment and strata-title property remediation techniques. We understand South Yarra residents need discrete, professional service that works seamlessly with body corporate requirements. Our mould removal South Yarra Melbourne service includes comprehensive strata management liaison.
                </p>
              </div>
