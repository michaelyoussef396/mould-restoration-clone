          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">Waterfront homes with premium designs requiring specialised humidity and moisture management.</p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <Shield className="w-4 h-4 text-success" />
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Wyndham Vale's master-planned communities require specialised containment strategies that protect modern finishes while preventing mould spore migration through contemporary open-plan designs and estate-wide air circulation systems.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Wyndham Vale's new build properties demand specialised removal techniques that account for modern synthetic materials, engineered building systems, and warranty considerations for recent construction.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-teal rounded-full mt-2 flex-shrink-0"></div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
                    <span>5+ years specialising in Wyndham Vale master-planned community issues</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Wyndham Vale's master-planned properties require specialised ventilation strategies that account for modern construction air-tightness while managing moisture levels in growth area conditions and lake proximity humidity.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-teal rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <p className="text-lg text-muted-foreground mb-6">
                We provide growth area-specialised mould removal services throughout Wyndham Vale and nearby western growth corridor suburbs including:
              </p>
