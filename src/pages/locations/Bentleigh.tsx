        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Melbourne's premier mould removal specialists serving Bentleigh's garden suburb properties and established residential areas. IICRC-certified technicians with 5+ years experience treating period home moisture issues, weatherboard restoration, and mature suburb challenges. same-day professional service, 100+ properties restored with 5.0/5 star rating from Bentleigh homeowners.
            </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• same-day professional service response to Bentleigh</li>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Our IICRC-certified technicians provide professional service Same-day professional service to Bentleigh heritage properties, operating 7am-7pm daily with Professional service line availability for established residential areas. ABN: 47 683 089 652.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>Period home moisture professional service available</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving Bentleigh and all established garden suburbs • Heritage property specialists • Period home professional service available
            </p>
          </div>
        </div>
      </section>
