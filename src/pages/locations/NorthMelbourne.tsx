  ...
  return (
    <div className="min-h-screen bg-background">
      <LocationPageSEO
        ...
        title="Mould Removal North Melbourne - Emergency Response | Mould & Restoration Co"
        description="Professional mould removal in North Melbourne Melbourne. IICRC certified, 2-hour emergency response. Call 1800 954 117 for same-day North Melbourne mould inspection & removal."
      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in North Melbourne</span>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>2-hour emergency response to North Melbourne</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Upon receiving your call for mould removal North Melbourne Melbourne, our IICRC-certified technicians respond within 2 hours. We conduct comprehensive thermal imaging and moisture mapping specific to worker's cottages, heritage terraces, and racing precinct properties.
                      </p>
                      <ul className="space-y-2 text-sm">
                        <li>• 24/7 emergency response to North Melbourne (3051)</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Emergency Response to North Melbourne</div>
                </div>
                <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your North Melbourne worker's cottage, heritage terrace, or community housing property. Our IICRC-certified technicians provide 24/7 emergency response with 2-hour arrival guarantee. Trusted by heritage properties and community housing with a 5.0-star rating.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <Card className="bg-white text-gray-900">
                <CardContent className="p-6">
                  ...
                  <p className="mb-4">Call now for immediate mould removal North Melbourne Melbourne assistance. Our heritage and community housing specialists respond within 2 hours.</p>
