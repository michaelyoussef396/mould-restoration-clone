          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-blue-600">Oakleigh Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Heritage Mediterranean Architecture</h4>
                      <p className="text-gray-600">
                        Many Oakleigh homes reflect the suburb's strong Greek heritage with Mediterranean-style architecture from the post-war immigration period. These properties often feature unique construction materials and methods that require specialized mould removal approaches respecting cultural preservation.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Multi-Generational Family Homes</h4>
                      <p className="text-gray-600">
                        Oakleigh's Greek community values often results in extended families sharing homes or living in close proximity. These multi-generational properties may have higher occupancy levels and specialized cultural requirements that influence our mould removal Oakleigh Melbourne approaches.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Train Line Corridor Challenges</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Commercial Strip Integration</h4>
                      <p className="text-gray-600">
                        Oakleigh's vibrant Eaton Mall and commercial areas create unique microclimates for nearby residential properties. The blend of commercial and residential zones requires specialized knowledge of moisture management in mixed-use environments.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Card className="border-blue-200 bg-blue-50">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900">Oakleigh Area Coverage</h3>
                        <p className="text-gray-600">VIC 3166 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Established Post-War Homes</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Railway Corridor Properties</h3>
                  <p className="text-gray-600 mb-4">
                    Homes near Oakleigh Railway Station and the Frankston line corridor face unique environmental challenges from train vibrations, modified air circulation, and proximity to transport infrastructure. These properties require specialized mould removal Oakleigh Melbourne approaches.
                  </p>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Commercial-Residential Mixed Zones</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Modern Family Developments</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Community Organisation Properties</h3>
                  <p className="text-gray-600 mb-4">
                    Oakleigh's Greek Orthodox churches, community centres, and cultural organisations often occupy significant heritage properties requiring specialized mould management. These buildings serve important community functions and need culturally sensitive treatment approaches.
                  </p>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
                      <span>Community space optimization</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Multi-Generational Safe Methods</h3>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Flexible Community Scheduling</h3>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Transport Corridor Expertise</h3>
                  <p className="text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Respect Original Mediterranean Features</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Multi-Generational Living Considerations</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Traditional Cooking Moisture Management</h4>
                      <p className="text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Railway Vibration Considerations</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Enhanced Air Filtration Systems</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Commercial Area Drainage Monitoring</h4>
                      <p className="text-gray-600">
