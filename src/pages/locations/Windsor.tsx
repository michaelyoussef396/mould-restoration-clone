        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal in Windsor Melbourne with same-day response. IICRC-certified technicians specializing in Victorian terraces, heritage apartments, and modern urban properties. 5.0 stars, 100+ properties restored.
            </p>
