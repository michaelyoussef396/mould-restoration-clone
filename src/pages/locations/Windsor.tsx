...
export const Windsor = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <LocationPageSEO
        title="Mould Removal Windsor Melbourne - Emergency Response | Mould & Restoration Co"
        description="Professional mould removal in Windsor Melbourne. IICRC certified, 2-hour emergency response. Call 1800 954 117 for same-day Windsor mould inspection & removal."
        suburb="Windsor"
        postcode="3181"
      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in Windsor</span>
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="emergency-cta">
                ...
                Call Now for Windsor Mould Emergency: 1800 954 117
              </Button>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h4 className="text-xl font-semibold mb-4 text-primary">Urban Village Emergency Response</h4>
                <p className="text-muted-foreground mb-4">
                  When you need urgent mould removal Windsor, our emergency response team reaches your property within 2 hours. Operating 7am-7pm every day with ABN 47 683 089 652, we provide immediate containment and assessment with village-appropriate methods. Our 100% satisfaction guarantee ensures complete peace of mind.
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-primary">Village Emergency Response</h3>
