        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Professional mould removal in Windsor Melbourne with same-day response. IICRC-certified technicians specialising in Victorian terraces, heritage apartments, and modern urban properties. 5.0 stars, 100+ properties restored.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>same-day professional service to Windsor</span>
                </div>
                <div className="flex items-center gap-3">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12">
            <p className="text-lg text-muted-foreground mb-6">
              Our mould removal Windsor Melbourne team understands the unique challenges facing this charming inner-city village. Located in postcode 3181, Windsor combines Victorian-era terraces with contemporary urban developments, creating specific moisture management challenges. With a mix of heritage properties, modern apartments, and the busy Chapel Street precinct, Windsor presents distinctive mould risks that require specialised local expertise.
            </p>

            <p className="text-lg text-muted-foreground mb-6">
              The suburb's village atmosphere, heritage building stock, and proximity to entertainment and shopping precincts creates unique humidity levels and ventilation challenges. Properties along Chapel Street, around Dandenong Road, and in the quiet residential streets experience different moisture patterns due to varying building ages, architectural styles, and urban activity levels. Our professional mould removal Windsor service responds Same-day professional service to protect your heritage terrace or modern apartment.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  All our technicians are IICRC certified with specialised training in heritage terrace and urban village remediation techniques. We understand Windsor residents need considerate service that respects the community atmosphere. Our mould removal Windsor Melbourne service includes comprehensive neighbourhood impact assessments.
                </p>
              </div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-accent-blue rounded-full"></div>
                    <span>Heritage ventilation system optimisation</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-accent-blue rounded-full"></div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">Contemporary apartment developments requiring specialised urban density treatment approaches.</p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <Shield className="w-4 h-4 text-success" />
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">Mixed-use commercial and residential properties along Chapel Street requiring specialised treatment.</p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <Shield className="w-4 h-4 text-success" />
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• same-day professional service response to Windsor</li>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary-600 text-white">
                <Phone className="w-5 h-5 mr-2" />
                Windsor Heritage Professional Service: 1800 954 117
              </Button>
