            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-medium">Same-Day Professional Service Fairfield</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sm">Fairfield 3078, Alphington 3078</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sm">Same-day professional service to Fairfield</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:pl-8">
                <Card className="shadow-xl">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-charcoal mb-4">Why Choose Mould & Restoration Co. in Fairfield?</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sm">Period properties along Station Street and surrounding areas often face ventilation challenges and heritage-appropriate mould treatment requirements.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-success mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Riverside Properties</h4>
                      <p className="text-professional text-sm">Homes near the Yarra River and riverside walking trails experience elevated moisture conditions requiring specialised mould prevention and treatment.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sm">Established family residences throughout Fairfield may experience moisture penetration and require careful restoration to maintain structural integrity.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-success mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Modern Apartments & Units</h4>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-success mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Local Cafes & Restaurants</h4>
                      <p className="text-professional text-sm">Food service establishments throughout Fairfield need rapid mould response to maintain health compliance and customer safety standards.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sim">Local centres, libraries and community spaces require immediate mould response to maintain safe environments for Fairfield residents.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-professional text-sm">Schools and childcare centres require immediate mould response to ensure safe learning environments for Fairfield's growing families.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-charcoal mb-4">Riverside Climate Factors</h3>
        ...
        <div className="py-16 px-4 bg-primary">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">
              Need Professional Mould Removal in Fairfield?
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Don't let mould compromise your Fairfield property. Our IICRC certified technicians provide Professional service line response with 2-hour arrival time.
            </p>
