            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-medium">2-Hour Emergency Response Fairfield</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">2-hour emergency response to Fairfield</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <Card className="shadow-xl">
                  <CardContent className="p-6">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">2-hour emergency response to Fairfield and surrounding suburbs</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="py-16 px-4 bg-blue-600">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Don't let mould compromise your Fairfield property. Our IICRC certified technicians provide 24/7 emergency response with 2-hour arrival time.
            </p>
