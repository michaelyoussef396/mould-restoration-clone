            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-medium">2-Hour Professional Service - Same-day Available 7am-7pm Coburg</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Same-day professional service to Coburg</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="py-16 px-4 bg-blue-600">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Don't let mould compromise your Coburg property. Our IICRC certified technicians provide Professional service hotline (7am-7pm) response with 2-hour arrival time.
            </p>
