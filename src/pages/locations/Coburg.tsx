            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-medium">2-Hour Emergency Response Coburg</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Coburg 3058, Coburg North 3058</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">2-hour emergency response to Coburg</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:pl-8">
                <Card className="shadow-xl">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Mould & Restoration Co. in Coburg?</h3>
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">2-hour emergency response to Coburg and surrounding suburbs</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Californian bungalows and weatherboard homes throughout Coburg often experience ventilation challenges and moisture issues requiring targeted mould treatment.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Period Cottages & Terraces</h4>
                      <p className="text-gray-600 text-sm">Heritage homes near Bell Street and central Coburg areas may face rising damp and ventilation issues common to older construction methods.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Modern Townhouses & Units</h4>
                      <p className="text-gray-600 text-sm">Contemporary developments around Pentridge Village and near transport hubs may experience condensation issues due to modern construction methods.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Converted Flats & Apartments</h4>
                      <p className="text-gray-600 text-sm">Split residential properties and converted apartments along major roads require careful moisture management and mould prevention strategies.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Retail & Shopping Centres</h4>
                      <p className="text-gray-600 text-sm">Commercial premises along Sydney Road and Bell Street require immediate mould response to maintain customer safety and business operations.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Healthcare & Medical Facilities</h4>
                      <p className="text-gray-600 text-sm">Medical centres and healthcare providers need rapid mould remediation to maintain sterile environments and patient safety standards.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Schools and childcare centres require immediate mould response to ensure safe learning environments for Coburg's growing families.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Industrial & Warehouse Spaces</h4>
                      <p className="text-gray-600 text-sm">Light industrial facilities and storage spaces require comprehensive moisture control to protect goods and maintain workplace safety.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="py-16 px-4 bg-blue-600">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">
              Need Emergency Mould Removal in Coburg?
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Don't let mould compromise your Coburg property. Our IICRC certified technicians provide 24/7 emergency response with 2-hour arrival time.
            </p>
