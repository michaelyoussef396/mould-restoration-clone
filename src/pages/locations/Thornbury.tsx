            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-medium">2-Hour Emergency Response Thornbury</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Thornbury 3071, Alphington 3078</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">2-hour emergency response to Thornbury</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:pl-8">
                <Card className="shadow-xl">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Mould & Restoration Co. in Thornbury?</h3>
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">2-hour emergency response to Thornbury and surrounding suburbs</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Heritage Edwardian Homes</h4>
                      <p className="text-gray-600 text-sm">Period properties along High Street and neighbouring areas often face ventilation challenges and heritage-sensitive mould treatment requirements.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Converted Warehouses & Lofts</h4>
                      <p className="text-gray-600 text-sim">Former industrial spaces converted to residential use throughout Thornbury's hipster quarter often experience unique moisture and ventilation challenges.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Classic Melbourne homes throughout Thornbury may experience moisture penetration and require careful restoration to maintain character features.</p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Restaurants & Craft Breweries</h4>
                      <p className="text-gray-600 text-sm">Food service and brewing establishments around High Street need rapid mould response to maintain health compliance and food safety standards.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Retail & Hospitality Venues</h4>
                      <p className="text-gray-600 text-sm">Commercial premises and hospitality venues require minimal disruption during mould remediation to maintain customer service and business operations.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Office & Co-working Spaces</h4>
                      <p className="text-gray-600 text-sm">Professional offices and shared working spaces need rapid mould remediation to maintain healthy work environments and productivity.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="py-16 px-4 bg-blue-600">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">
              Need Emergency Mould Removal in Thornbury?
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Don't let mould compromise your Thornbury property. Our IICRC certified technicians provide 24/7 emergency response with 2-hour arrival time.
            </p>
