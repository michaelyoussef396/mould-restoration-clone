        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Melbourne's premier mould removal specialists serving Kooyong's premium residential area and tennis precinct properties. IICRC-certified technicians with 5+ years experience treating luxury home moisture challenges, leafy street properties, and premium residential restoration. same-day professional service, 100+ properties restored with 5.0/5 star rating from Kooyong residents.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>same-day professional service to Kooyong</span>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• same-day professional service response to Kooyong</li>
                    <li>• Premium residential professional moisture service</li>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
                    <span>5+ years specialising in Kooyong premium residential mould issues</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-blue rounded-full mt-2 flex-shrink-0"></div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Our IICRC-certified technicians provide professional service Same-day professional service to Kooyong premium residential properties, operating 7am-7pm daily with Professional service line availability for luxury property situations. ABN: 47 683 089 652.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  We work directly with all major Australian insurance providers and offer comprehensive documentation for claims related to premium property damage, luxury residential restoration, and tennis precinct water damage incidents requiring specialised treatment.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-success rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <p className="text-lg text-muted-foreground mb-6">
                We provide premium residential-specialised mould removal services throughout Kooyong and nearby luxury property areas including:
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>Tennis precinct moisture professional service available</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary-600 text-white">
                <Phone className="w-5 h-5 mr-2" />
                Kooyong Premium Professional Service: 1800 954 117
              </Button>
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving Kooyong and all premium residential suburbs • Tennis precinct specialists • Luxury property professional service available
            </p>
          </div>
        </div>
      </section>
