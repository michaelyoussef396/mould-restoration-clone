            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• Same-day service available to Alphington</li>
                    <li>• Family home mould specialist</li>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• Children's health air quality assessment</li>
                    <li>• Heritage family home evaluation</li>
                    <li>• Yarra River humidity mapping</li>
                    <li>• Family-specific air quality testing</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    ...
                    <li>• Non-toxic, child-safe treatments</li>
                    <li>• Heritage-safe techniques</li>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    ...
                    <li>• Insurance documentation for family homes</li>
                    <li>• Preventive maintenance scheduling</li>
                    <li>• Family health protection strategies</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving Alphington and all northeast Melbourne suburbs • Family home specialists • Child-safe treatment experts
            </p>
          </div>
        </div>
      </section>
