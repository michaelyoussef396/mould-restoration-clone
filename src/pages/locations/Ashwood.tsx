          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-charcoal mb-6">
                ...
                <span className="block text-primary">Ashwood Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal">Post-War Housing Challenges</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Established Garden Districts</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Family Home Renovations</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Quiet Residential Character</h4>
                      <p className="text-professional">
                ...
                <Card className="border-blue-200 bg-columbia">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-charcoal">Ashwood Area Coverage</h3>
                        <p className="text-professional">VIC 3147 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Post-War Family Homes</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Corner Block Properties</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Renovated Period Homes</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Garden Apartment Complexes</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">School District Properties</h3>
                  <p className="text-professional mb-4">
                  ...
                  <ul className="text-sm text-professional space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span>Family bathroom optimisation</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Family-Safe Methods</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">7am-7pm Every Day</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover-shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Local Knowledge</h3>
                  <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Inspect Original Timber Framing</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Update Period Ventilation Systems</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Monitor Extension Connections</h4>
                      <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Manage Mature Tree Canopy</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Maintain Proper Drainage</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Monitor Creek Proximity Effects</h4>
                      <p className="text-professional">
