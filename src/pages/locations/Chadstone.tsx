          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-charcoal mb-6">
                ...
                <span className="block text-primary">Chadstone Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-professional">
                        Proximity to Chadstone Shopping Centre creates unique environmental conditions for nearby residential properties. Large car park surfaces, extensive air conditioning systems, and high pedestrian traffic can affect local humidity patterns and require specialised mould removal approaches.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Mixed Housing Development Challenges</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Transport Hub Ventilation Issues</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Commercial-Residential Interface</h4>
                      <p className="text-professional">
                ...
                <Card className="border-blue-200 bg-columbia">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-charcoal">Chadstone Area Coverage</h3>
                        <p className="text-professional">VIC 3148 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Shopping Centre Proximity Homes</h3>
                  <p className="text-professional mb-4">
                    Properties within walking distance of Chadstone Shopping Centre face unique environmental challenges from heavy pedestrian traffic, extensive car parking areas, and modified local weather patterns. Our specialised approach addresses these commercial-residential interface issues.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Modern Unit Developments</h3>
                  <p className="text-professional mb-4">
                    Chadstone's newer apartment complexes and unit developments often feature contemporary building materials and shared ventilation systems. These properties require specialised mould prevention strategies that account for high-density living and shared building infrastructure.
                  </p>
                  <ul className="text-sm text-professional space-y-2">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Established Family Homes</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Student and Young Professional Housing</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Transport Corridor Properties</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Contemporary Townhouse Complexes</h3>
                  <p className="text-professional mb-4">
                  ...
                  <ul className="text-sm text-professional space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span>Natural ventilation optimisation</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-professional">
                    Extensive experience with Chadstone's unique commercial-residential environment and diverse property types. We understand how the shopping centre's presence affects local residential properties and have developed specialised treatment approaches.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Comprehensive Assessment</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Advanced Treatment Methods</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Flexible Scheduling</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Commercial-Residential Expertise</h3>
                  <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Enhanced Air Filtration</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Monitor Traffic-Related Humidity</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Seal Against Pollution Infiltration</h4>
                      <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Coordinate Unit Complex Maintenance</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Address Shared Wall Moisture</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Optimize Modern Ventilation Systems</h4>
                      <p className="text-professional">
