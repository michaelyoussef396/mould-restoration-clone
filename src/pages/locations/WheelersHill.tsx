          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-blue-600">Wheelers Hill Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Modern Construction Standards</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Family Lifestyle Moisture Challenges</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Established Landscaping Integration</h4>
                      <p className="text-gray-600">
                ...
                <Card className="border-blue-200 bg-blue-50">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900">Wheelers Hill Area Coverage</h3>
                        <p className="text-gray-600">VIC 3150 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Contemporary Family Homes</h3>
                  <p className="text-gray-600 mb-4">
                    Wheelers Hill's signature modern family homes from the 1980s-2000s development period feature contemporary construction methods, open-plan living, and modern amenities. These properties require specialized mould treatment approaches that account for modern building materials and ventilation systems.
                  </p>
                  <ul className="text-sm text-gray-600 space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
                      <span>Contemporary ventilation optimization</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Shopping Centre Proximity Properties</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Family Activity-Focused Residences</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Maturing Landscape Properties</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Extended and Renovated Properties</h3>
                  <p className="text-gray-600 mb-4">
                    Many Wheelers Hill families have extended their homes to accommodate growing needs, adding decks, outdoor entertaining areas, and additional living spaces. These modifications can create moisture challenges requiring specialized mould removal expertise.
                  </p>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Parkland Adjacent Properties</h3>
                  <p className="text-gray-600 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">5+ Years Modern Suburb Experience</h3>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Contemporary Building Expertise</h3>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Family-Safe Modern Methods</h3>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Shopping Centre Area Knowledge</h3>
                  <p className="text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Active Family Moisture Control</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Contemporary Ventilation System Maintenance</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Open Plan Living Humidity Control</h4>
                      <p className="text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Shopping Centre Area Air Quality</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Mature Landscape Drainage Monitoring</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Park Proximity Considerations</h4>
                      <p className="text-gray-600">
