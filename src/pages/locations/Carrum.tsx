  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceSchema
        ...
        description="Emergency mould removal and inspection services for Carrum properties including station precinct buildings, beachside homes, and mixed residential developments."
      />
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Emergency mould removal Carrum Melbourne specialists with 5+ years experience. IICRC-certified technicians serving Carrum's station & beach living properties, Carrum Station precinct, and beachside residential developments with same-day response. Trusted by 100+ Melbourne properties with 5.0-star rating.
            </p>
