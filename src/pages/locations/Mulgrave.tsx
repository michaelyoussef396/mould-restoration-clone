  ...
  return (
    <div className="min-h-screen bg-background">
      <LocationPageSEO
        ...
        description="Professional mould removal in Mulgrave Melbourne. IICRC certified, 2-hour emergency response. Call 1800 954 117 for same-day Mulgrave mould inspection & removal."
      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in Mulgrave</span>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>2-hour emergency response to Mulgrave</span>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Emergency Response to Mulgrave</div>
                </div>
                <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your Mulgrave family home, established property, or children's health. Our IICRC-certified technicians provide 24/7 emergency response with 2-hour arrival guarantee. Trusted by families, established neighborhoods, and suburban communities with a 5.0-star rating.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <Card className="bg-white text-gray-900">
                <CardContent className="p-6">
                  ...
                  <p className="mb-4">Call now for immediate mould removal Mulgrave Melbourne assistance. Our family suburb specialists respond within 2 hours.</p>
