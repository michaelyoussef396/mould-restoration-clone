  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LocalBusinessSchema
        ...
        abn="47 683 089 652"
        description="Professional mould removal and inspection services in Noble Park Melbourne. IICRC certified technicians specialising in residential community properties, Douglas Street corridor, and established family neighborhoods."
      />
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-professional">Professional Service - Same-day Available 7am-7pm to Noble Park</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-sm text-professional">Rating from Noble Park Families</div>
                </div>
              </div>
            </div>
          </div>
