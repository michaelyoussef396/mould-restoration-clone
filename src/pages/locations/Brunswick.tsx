                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Brunswick 3056, Brunswick East 3057</p>
                    </div>
                  </div>
                  <div className="flex items-start">
              ...
              <div className="lg:pl-8">
                <Card className="shadow-xl">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Mould & Restoration Co. in Brunswick?</h3>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Victorian Terraces & Period Homes</h4>
                      <p className="text-gray-600 text-sm">Heritage properties along Albion Street and surrounding areas often face ventilation challenges and rising damp issues requiring specialised mould treatment approaches.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Warehouse Conversions & Lofts</h4>
                      <p className="text-gray-600 text-sm">Former industrial spaces converted to residential use around Brunswick's artistic quarter often experience unique moisture and ventilation challenges.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Student Accommodation</h4>
                      <p className="text-gray-600 text-sm">High-occupancy student housing near universities requires rapid mould response to maintain healthy living environments.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Arts & Creative Spaces</h4>
                      <p className="text-gray-600 text-sm">Brunswick's numerous galleries, studios and creative spaces require careful mould management to protect valuable artworks and maintain air quality.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Restaurants & Cafes</h4>
                      <p className="text-gray-600 text-sm">Food service establishments along Sydney Road and Union Street need immediate mould response to maintain health compliance and customer safety.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Retail & Office Spaces</h4>
                      <p className="text-gray-600 text-sm">Commercial premises require minimal business disruption during mould remediation, with after-hours and weekend service availability.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Schools and childcare centres require immediate mould response to ensure safe learning environments for Brunswick's families.</p>
                    </div>
                  </div>
                </div>
              </div>
