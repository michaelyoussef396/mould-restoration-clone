  ...
  return (
    <div className="min-h-screen bg-background">
      <LocationPageSEO
        ...
        title="Mould Removal South Melbourne - Emergency Response | Mould & Restoration Co"
        description="Professional mould removal in South Melbourne Melbourne. IICRC certified, 2-hour emergency response. Call 1800 954 117 for same-day South Melbourne mould inspection & removal."
      ...
      <LocalBusinessSchema
        ...
        abn="47 683 089 652"
        description="Professional mould removal and inspection services in South Melbourne Melbourne. IICRC certified technicians specializing in mixed housing, market area properties, and Albert Park precinct buildings."
      />
      ...
      <div className="emergency-bar">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4 text-sm font-semibold">
            ...
            <span>24/7 Emergency Mould Response in South Melbourne</span>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span>2-hour emergency response to South Melbourne</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Upon receiving your call for mould removal South Melbourne Melbourne, our IICRC-certified technicians respond within 2 hours. We conduct comprehensive thermal imaging and moisture mapping specific to heritage terraces, modern apartments, and market-adjacent properties.
                      </p>
                      <ul className="space-y-2 text-sm">
                        <li>• 24/7 emergency response to South Melbourne (3205)</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Emergency Response to South Melbourne</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-2">100%</div>
                  <div className="text-sm text-gray-600">Mixed Community Safe Methods</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-2">5.0★</div>
                  <div className="text-sm text-gray-600">Rating from Heritage & Modern Properties</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Don't let mould compromise your South Melbourne heritage terrace, modern apartment, or commercial property. Our IICRC-certified technicians provide 24/7 emergency response with 2-hour arrival guarantee. Trusted by heritage properties, market area businesses, and modern developments with a 5.0-star rating.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <Card className="bg-white text-gray-900">
                <CardContent className="p-6">
                  ...
                  <p className="mb-4">Call now for immediate mould removal South Melbourne Melbourne assistance. Our heritage and modern property specialists respond within 2 hours.</p>
