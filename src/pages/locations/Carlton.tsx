        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Melbourne's premier mould removal specialists serving Carlton's heritage properties and university precinct. IICRC-certified technicians with 5+ years experience treating Victorian terraces, student housing, and heritage buildings. Same-day emergency response, 100+ properties restored with 5.0/5 star rating.
            </p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
                    <span>Emergency mould removal Carlton: 2-hour response guarantee 24/7</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-emergency-orange rounded-full mt-2 flex-shrink-0"></div>
