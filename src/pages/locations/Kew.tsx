        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Melbourne's premier mould removal specialists serving Kew's leafy established suburb and heritage family homes. IICRC-certified technicians with 5+ years experience treating period properties, family residences, and Studley Park area homes. Same-day emergency response, 100+ properties restored with 5.0/5 star rating from Kew families.
            </p>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto text-primary-foreground/90">
            Protect your prestigious Kew property and family's health with expert mould removal services. Our IICRC-certified specialists provide same-day emergency response with specialist treatment for heritage homes and contemporary properties throughout postcode 3101.
          </p>
