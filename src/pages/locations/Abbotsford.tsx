            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• Same-day service available to Abbotsford</li>
                    <li>• Warehouse conversion mould specialist</li>
                    <li>• Professional moisture assessment</li>
                    <li>• River humidity evaluation</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• Artist studio air quality assessment</li>
                    <li>• Industrial building moisture evaluation</li>
                    <li>• Yarra River humidity mapping</li>
                    <li>• Warehouse-specific air quality testing</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    ...
                    <li>• Industrial material-compatible treatments</li>
                    <li>• Warehouse conversion-safe techniques</li>
                    <li>• River environment clearance testing</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>• Long-term river humidity management</li>
                    <li>• Insurance documentation for industrial heritage</li>
                    <li>• Preventive maintenance scheduling</li>
                    <li>• Creative space air quality optimisation</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving Abbotsford and all inner north Melbourne suburbs • Industrial heritage specialists • Artist studio air quality experts
            </p>
          </div>
        </div>
      </section>
