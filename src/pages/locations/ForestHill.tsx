          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-charcoal mb-6">
                ...
                <span className="block text-primary">Forest Hill Melbourne</span>
              </h1>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal">Quiet Residential Character Protection</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Whitehorse Area Family Needs</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Established Suburban Development Challenges</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-charcoal">Natural Environment Integration</h4>
                      <p className="text-professional">
                ...
                <Card className="border-blue-200 bg-columbia">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-charcoal">Forest Hill Area Coverage</h3>
                        <p className="text-professional">VIC 3131 and surrounding suburbs</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Quiet Family Residences</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Whitehorse Municipality Properties</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">School Proximity Family Homes</h3>
                  <p className="text-professional mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <ul className="text-sm text-professional space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span>Landscape drainage optimisation</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Multi-Generational Residential Properties</h3>
                  <p className="text-professional mb-4">
                  ...
                  <ul className="text-sm text-professional space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span>Long-term family home optimisation</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Contemporary Suburban Developments</h3>
                  <p className="text-professional mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">5+ Years Residential Community Experience</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Family-Centered Service Approach</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Quiet Residential Treatment Methods</h3>
                  <p className="text-professional">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-charcoal mb-3">Whitehorse Area Knowledge</h3>
                  <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Family Activity Moisture Management</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Quiet Ventilation Solutions</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Multi-Generational Home Considerations</h4>
                      <p className="text-professional">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Established Garden Drainage Management</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">School Schedule Coordination</h4>
                      <p className="text-professional">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-charcoal mb-2">Community-Conscious Maintenance</h4>
                      <p className="text-professional">
